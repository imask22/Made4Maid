...
<form action = "forgot_process.jsp" method = "post">

    <label><h4>ID</h4></label>
    <input type = "text" class="form-control" name = "id" autocomplete="off"><br>
<input type = "submit" class="btn btn-secondary w-50" value = "change password">
</form>
    </div>
    </div>
</body>
