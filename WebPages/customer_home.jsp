...
<%
if(request.getParameterMap().containsKey("cannotpost"))
{
int result = Integer.parseInt(request.getParameter("cannotpost"));
System.out.println(result);
				...
				if(result == 1)
				{
					...
					alert("Cannot send post to already connected maid!!!!");
    ...
    <hr>
     <h3>Guidelines to Follow-</h3>
        ...
        <h5>
            ...
            6. Don't argue with the money if you have any issues you can post your issue or email us.<br>
