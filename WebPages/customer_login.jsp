...
<div class="container text-center my-5 pt-5">    
    ...
    <h1 class="text-center text-bold text-capatalize p-3 ">LOGIN</h1>
        <div class="row">
            ...
            <div class=" col-md-6 col-xl-6 col-12 my-3">
                <div class="left">
                    
                    
                <form action = "customer_signin_process.jsp" method = "post">
                    ...
                    <div class="container pt3 text-bold">
                        <h5>    <label class="text-bold">PASSWORD</label></h5>
                         <div class="input-container">
                          ...
                          <input type="password" class="form-control" id="pass" name="password"   onfocus="this.value=''"  required>
                                     </div>
                    </div>
                 ...
                 <div class="col-mg-12 col-xl-12 col-12 m-4">
                  ...
                  <div class="col-mg-12 col-xl-12 col-12 m-4">
                   ...
                   <div class="col-mg-12 col-xl-12 col-12 m-4">
                    ...
                    <img src="images/customer.jpg"id="customer">

             </div>
            </div>
            <h3>
    		<a class="btn btn-light col-12"  href="customer_forgot_password.jsp">FORGOT PASSWORD!!</a>
                
    		<a class="btn btn-light col-12"  href="customer_signup.jsp" id="signup">CREATE ACCOUNT !!</a>
            </h3>
