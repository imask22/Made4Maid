...
<div class="container my-5 text-center text-capatalize">
    ...
    <h1 class="pt-5">"REQUESTS DENIED BY MAIDS"</h1>
...
lst = wdo.fetchDenyReasoncustomer();
if(lst!=null)
{
	for(whydeny w : lst)
	{
		%>
                ...
                <h4 clss="text-bold">POST_DESC: <%String temp= w.getWhyDesc();
                    if(temp==null){
                ...
                %></h4>
                        <h4 clss="text-bold">MAID_ID: <%=w.getCustid() %></h4>
		    <hr>
