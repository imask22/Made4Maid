...
for(maidimg lst  : pqr)
{
	...
	File image = new File("C:\\\\Users\\\\asus\\\\Desktop\\\\interview_projects\\\\made4maid\\\\WebContent\\\\img_not_verified\\\\"+ask);
...
response.sendRedirect("bill_pic_process.jsp");
